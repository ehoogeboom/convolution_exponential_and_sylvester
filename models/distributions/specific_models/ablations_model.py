...
from models.transformations.sylvester.ablations import AblationNoBasis, \
    AblationWithoutGeneralization


class Ablation(BaseDistribution):
    def __init__(self, args, input_size, n_levels, n_subflows, use_splitprior, normalize_translation, normalize_scale):
        ...
        if args.model_type == 'ablation_nobasis':
            FlowModule = AblationNoBasis
        elif args.model_type == 'ablation_nogeneralized':
            FlowModule = AblationWithoutGeneralization
        else:
        ...
        for level in range(n_levels):
            ...
            if level < n_levels - 1:
                ...
                current_size = (
                    current_size[0] * 4,
                    current_size[1] // 2, current_size[2] // 2
                )
